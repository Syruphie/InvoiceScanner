...
export default function ResultsScreen({ route }) {
  ...
  const scannedWhen = meta.source === 'gallery' ? 'Uploaded from gallery' : 'Scanned just now';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.helperText}>Ready for backend connection when your API endpoint is available.</Text>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  helperText: { color: '#6a6a6a', fontSize: 12, marginTop: 14, marginBottom: 32 },
});
